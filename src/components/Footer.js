...
const Footer = () => {
  return (
    <footer className="Footer">
      <p className="Footer-madeby">&copy; 2017 Fred Hawk</p>
      <a className="Footer-githublink" href="https://github.com/osycon/tally-quote" target="_blank" rel="noopener noreferrer">
        Project on Github
        <svg
